      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="glass-panel p-8 rounded-2xl shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
            <UserPlus className="w-6 h-6 text-violet-400" /> Create Account
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className="w-full pl-10 pr-4 py-2.5 bg-[#0d1424]/60 border border-slate-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent text-sm transition-all"
            ...
            <button
              type="submit"
              className="w-full mt-2 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 font-semibold rounded-xl text-sm transition-all shadow-lg hover:shadow-violet-500/20 active:scale-[0.98] flex items-center justify-center gap-2"
              disabled={loading}
            >
              {loading ? (
                <>
